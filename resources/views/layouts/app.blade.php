...
<body>
    <div class="flex h-screen bg-gray-200 font-roboto" x-data="{ sidebarOpen: false }">
        ...
        <div :class="sidebarOpen? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <div class="flex items-center justify-center mt-4">
                <div class="flex items-center">
                    <svg class="h-12 w-12" viewBox="0 0 512 512" fill="none" xmlns="https://www.w3.org/2000/svg">
                        <path
            ...
            <nav class="mt-5">
                <a href="{{ route('admin.dashboard.index') }}"
                    class="flex items-center mt-4 py-2 px-6 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/dashboard*') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}">
                ...
                <a href="{{ route('admin.category.index') }}"
                    class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/category*') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="https://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.slider.index') }}"
                    class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/slider*') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500'}}">
            ...
            <header class="flex justify-between items-center py-4 px-6 bg-white">
                <div class="flex items-center">
                    <button @click="sidebarOpen = true" class="text-gray-500 focus:outline-none lg:hidden">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                ...
                <div class="flex items-center">
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        {{-- <div x-show="dropdownOpen" @click="dropdownOpen = false" class="fixed inset-0 h-full w-full z-0"></div> --}}
