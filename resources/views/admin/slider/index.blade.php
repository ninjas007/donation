        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('admin.slider.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        <label for="name" class="text-gray-700">LINK SLIDER</label>
                        <input type="text" name="link" value="{{ old('link') }}" placeholder="Link Promo"
                            class="form-input w-full mt-2 rounded-md bg-gray-200 focsus:bg-white">
                        @error('link')
                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{ $message }}</p>
                        ...
                        @forelse ($sliders as $slider)
                            <tr class="border bg-white">
                                ...
                                <td class="px-6 py-2 flex justify-center">
                                    <img src="{{ $slider->image }}" alt="" class="object-fit-cover rounded" style="width: 35%">
                                </td>
                                <td class="px-6 py-2">
                                    {{ $slider->link }}
                                </td>
