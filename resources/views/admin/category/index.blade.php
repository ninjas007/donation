            ...
            <div class="flex items-center">
                ...
                <div class="relative mx-4">
                    ...
                    <form action="{{ route('admin.category.index') }}" method="GET">
                        <input type="text" name="q" value="{{ request()->query('q') }}" placeholder="Search" class="form-input w-full rounded-lg pl-10 pr-4">
                    </form>
                </div>
            </div>
                            ...
                            @forelse ($categories as $category)
                                <tr class="border bg-white">
                                    ...
                                    <td class="px-6 py-2 flex justify-center">
                                        <img src="{{ $category->image }}" alt="" class="w-10 h-100 object-fit-cover rounded-full">
                                    </td>
                                    <td class="px-6 py-2">
                                        {{ $category->name }}
                                    </td>
                                    <td class="px-10 py-2 text-center">
                                        ...
                                        <button onClick="destroy(this.id)" id="{{ $category->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white fouces:outline-none">Hapus</button>
                                    </td>
