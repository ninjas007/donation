        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                ...
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <div class="mt-4">
                        ...
                        <form action="{{ url('user/two-factor-authentication') }}" method="post">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-gray-600 text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Enable
                                Two-Factor</button>
                        </form>
                        @else
                        {{-- Disable 2FA --}}
                        <form action="{{ url('user/two-factor-authentication') }}" method="post">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-red 600 text-gray-200 rounded-md hover:bg-red-900 focus:outline-none focus:bg-gray-700">Disable
                                Two-Factor</button>
                        </form>
                        ...
                        <form action="{{ url('user/two-factor-recovery-codes') }}" method="post">
                            ...
                            <button type="submit"
                                class="mt-4 px-4 py-2 bg-gray-600 text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Regenerate
            ...
            <div>
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <hr class="mt-4">
                    <form action="{{ route('user-profile-information.update') }}" method="post" class="mt-4">
                        @csrf
                        @method('PUT')
                        <div>
                            <label class="block">
                                ...
                                <input type="text" name="name" value="{{ old('name') ?? auth()->user()->name }}"
                                    placeholder="Nama Lengkap" class="form-input mt-1 block w-full rounded-md">
                                @error('name')
                                <div
                        ...
                        <div class="mt-4">
                            <label class="block">
                                ...
                                <input type="email" name="email" value="{{ old('email') ?? auth()->user()->email }}"
                                    placeholder="Alamat Email" class="form-input mt-1 block w-full rounded-md">
                                @error('email')
                                <div
                                    class="inline-flex max-w-sm w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
